...
class VehicleDetectionApp(QMainWindow):
    def __init__(self):
        ...
        self.frame_rate = 60  # Assuming a 30 FPS video for now
        self.pixels_to_meter_ratio = 0.05  # Conversion ratio, adjust based on scene

    def initUI(self):
        # Window properties
        self.setWindowTitle("Vehicle Detection & Speed Estimation")
    ...
    def start_video(self):
        ...
        if self.frame_rate == 0:
            self.frame_rate = 30  # Default to 30 FPS if video file frame rate cannot be retrieved
    ...
    def update_frame(self):
        ...
        if ret:
            ...
            detected_frame, vehicle_speeds = self.detect_vehicles_and_calculate_speed(frame)
